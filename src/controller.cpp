...
void Controller::parse(const uint8_t* data, const size_t length) {
  axes.x = ((int8_t) data[0] > 15 || (int8_t) data[0] < -15) ? (int8_t) data[0] : 0;
  axes.y = ((int8_t) data[1] > 15 || (int8_t) data[1] < -15) ? (int8_t) data[1] : 0;
  axes.z = ((int8_t) data[2] > 15 || (int8_t) data[2] < -15) ? (int8_t) data[2] : 0;
  axes.rz = ((int8_t) data[3] > 15 || (int8_t) data[3] < -15) ? (int8_t) data[3] : 0;
